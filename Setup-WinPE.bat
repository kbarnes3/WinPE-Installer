...
@set SURFACE3DRIVERS=Surface3
@set SURFACEPRO3DRIVERS=SurfacePro3
@set SURFACEPRO4DRIVERS=SurfacePro4
@set SURFACEBOOKDRIVERS=SurfaceBook
...
mkdir %DRIVERSROOT%
7z x %SURFACE3ZIP% -o%DRIVERSROOT%\%SURFACE3DRIVERS%
7z x %SURFACEPRO3ZIP% -o%DRIVERSROOT%\%SURFACEPRO3DRIVERS%
7z x %SURFACEPRO4ZIP% -o%DRIVERSROOT%\%SURFACEPRO4DRIVERS%
7z x %SURFACEBOOKZIP% -o%DRIVERSROOT%\%SURFACEBOOKDRIVERS%
