...
REM 7z x %SURFACE3ZIP% -o%SURFACE3DRIVERS%
REM 7z x %SURFACEPRO3ZIP% -o%SURFACEPRO3DRIVERS%
REM 7z x %SURFACEPRO4ZIP% -o%SURFACEPRO4DRIVERS%
REM 7z x %SURFACEBOOKZIP% -o%SURFACEBOOKDRIVERS%
