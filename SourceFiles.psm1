...
function Get-IntelWifiDrivers {
    return "$env:DISC_PATH\Drivers\Framework_W11_24H2_OOBE_Wifi_Driver_Package\Intel_PROSet_WiFi_24.30.0.3"
}

function Get-AmdRZ616WifiDrivers {
    return "$env:DISC_PATH\Drivers\Framework_W11_24H2_OOBE_Wifi_Driver_Package\RZ616_Wifi_3.4.0.1335"
}

function Get-AmdRZ717WifiDrivers {
    return "$env:DISC_PATH\Drivers\Framework_W11_24H2_OOBE_Wifi_Driver_Package\RZ717_WiFI_5.7.0.5416"
}
