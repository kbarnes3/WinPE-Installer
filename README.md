...
* The latest Cumulative Updates for Windows Server 2025, available from [here](https://support.microsoft.com/en-us/topic/windows-server-2025-update-history-10f58da7-e57b-4a9d-9c16-9f1dcd72d7d7). These are the same as the updates for Windows 11, 25H2.
