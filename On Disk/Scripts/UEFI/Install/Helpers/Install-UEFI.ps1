...
if ($SplitImageFilePattern) {
    ...
    Expand-WindowsImage -ImagePath $ImagePath -Name $ImageName -ApplyPath W:\ -ScratchDirectory $ScratchDir -Compact:$Compact -ErrorAction Stop
}
